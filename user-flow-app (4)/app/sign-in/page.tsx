      ...
      <div className="flex-1 flex flex-col items-center justify-center p-4">
        ...
        <Card className="w-full max-w-md">
          <CardHeader>
            ...
            <CardDescription className="text-center">Sign in to your BusGo account</CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card className="w-full max-w-md mt-4">
          ...
          <CardContent className="space-y-2 text-sm">
            <div>
              ...
              <p className="text-muted-foreground">Email: passenger@example.com</p>
              <p className="text-muted-foreground">Password: password123</p>
            </div>
            <div>
              <p className="font-medium">Conductor:</p>
              <p className="text-muted-foreground">Email: dextermiranda441@gmail.com</p>
              <p className="text-muted-foreground">Password: password</p>
            </div>
            <div>
              <p className="font-medium">Admin:</p>
              <p className="text-muted-foreground">Email: mdexter958@gmail.com</p>
              <p className="text-muted-foreground">Password: password</p>
            </div>
          </CardContent>
        </Card>
